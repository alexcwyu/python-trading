...
_SERIES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='provider_id', full_name='algotrader.model2.Series.provider_id', index=4,
