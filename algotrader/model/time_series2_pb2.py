...
_SERIES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='algotrader.model2.Series.id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='parent_id', full_name='algotrader.model2.Series.parent_id', index=1,
