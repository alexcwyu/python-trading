...
class OrderTest(TestCase):
    ...
    def test_leave_qty(self):
        ...
        er1 = ExecutionReport(ord_id=1, er_id=1, instrument="HSI", last_qty=800, last_price=18.4,
    ...
    def test_exec_report_with_diff_ord_id(self):
        ...
        er1 = ExecutionReport(ord_id=2, er_id=1, instrument="HSI", last_qty=800, last_price=18.4,
                              status=OrdStatus.PARTIALLY_FILLED)
    ...
    def test_exec_report_with_exceed_qty(self):
        ...
        er3 = ExecutionReport(ord_id=1, er_id=3, instrument="HSI", last_qty=100, last_price=18.4,
                              status=OrdStatus.FILLED)
        with self.assertRaises(Exception) as ex:
