...
bar = Bar(instrument=3, open=18, high=19, low=17, close=17.5, vol=1000)
#quote = Quote(instrument=3, bid=18, ask=19, bid_size=200, ask_size=500)
#trade = Trade(instrument=3, price=20, size=200)
...
print bar_id
print bars.find_one()
print bars.find_one({"instrument": "3"})
