...
class PositionTest(TestCase):
    def test_add_order(self):
        position = Position(1)
        self.assertEquals(0, position.total_qty())
        ...
        self.assertEquals(1000, position.ordered_size)
        ...
        self.assertEquals(2000, position.ordered_size)
        ...
        self.assertEquals(800, position.ordered_size)
    ...
    def test_fill_qty(self):
        ...
        position.add_position(er1.ord_id, er1.last_qty)
        self.assertEquals(500, position.total_qty())
        ...
        position.add_position(er2.ord_id, er2.last_qty)
        self.assertEquals(1000, position.total_qty())
        ...
        position.add_position(er3.ord_id, er3.last_qty * -1)
        self.assertEquals(200, position.total_qty())
        ...
        position.add_position(er4.ord_id, er4.last_qty * -1)
        self.assertEquals(-200, position.total_qty())
